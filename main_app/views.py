...
# finchs = [
#   {'breed': 'American Goldfinch', 'description': 'vibrant yellow with some balck markings' 'age': 3},
#   {'breed': 'Housefinch', 'description': 'red and lightbrown' 'age': 0},
#   {'breed': 'Strawberry finch', 'description': 'vibrant red with white and balck markings' 'age': 8},
# ]
